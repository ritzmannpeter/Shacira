...
class SH_QT_WIDGET_PLUGIN_EXPORT CWidgetStack : public QWidgetStack, public CWidgetBase  
{
...
protected:
   ...
   {
      QWidgetStack::mousePressEvent (e);
   };
   virtual void mouseReleaseEvent(QMouseEvent * e)
   {
      QWidgetStack::mouseReleaseEvent(e);
   };
   ...
   {
      QWidgetStack::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      QWidgetStack::focusOutEvent(e);
   };
   void keyReleaseEvent(QKeyEvent * e)
   {
      QWidgetStack::keyReleaseEvent(e);
   };
