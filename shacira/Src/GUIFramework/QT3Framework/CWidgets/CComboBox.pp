...
typedef QValueVector<QString> Q_STRING_VECTOR_T;

class SH_QT_WIDGET_PLUGIN_EXPORT CComboBox : public QComboBox, public CWidgetBase  
{
...
public:
   CComboBox(bool rw, QWidget * parent = 0, const char * name = 0);
   ~CComboBox();
   void AdjustItemHeight();
protected:
   cInput _Input;
   QString _PrevValue;
   Q_STRING_VECTOR_T * _ItemStrings;
protected:
