...
/**!
  * @brief A container widget derived from QButtonGroup to organize button widgets.
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CButtonGroup : public QButtonGroup, public CWidgetBase  
{
...
protected:
   ...
   {
      QButtonGroup::paintEvent(e);
   };
   virtual void focusInEvent(QFocusEvent * e)
   {
      QButtonGroup::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      QButtonGroup::focusOutEvent(e);
   };
   void keyReleaseEvent(QKeyEvent * e)
   {
      QButtonGroup::keyReleaseEvent(e);
   };
public: 
