...
class SH_QT_WIDGET_PLUGIN_EXPORT CProtocolWindow : public QTextEdit, public CWidgetBase  
{
...
public:
   ...
   PROPERTY_2i(QCString,Key)
   PROPERTY_2i(QCString,ObjectName)
...
public:
   CProtocolWindow(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CProtocolWindow();
