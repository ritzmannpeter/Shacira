...
/**!
  ...
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CListView : public QListView, public CWidgetBase  
{
...
public:
   ...
   ~CListView();
   void AdjustItemHeight(QListViewItem * item = NULL);
private:
   void SetImage(QListViewItem * item, QPixmap & pixmap);
};
