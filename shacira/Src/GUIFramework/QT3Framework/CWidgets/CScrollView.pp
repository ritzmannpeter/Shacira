...
/**!
  ...
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CScrollView : public QScrollView, public CWidgetBase
{
   Q_OBJECT
...
public:
   CScrollView(CPage * page, QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CScrollView();
   CPage * Page()
   {
      return _Page;
