...
class SH_QT_WIDGET_PLUGIN_EXPORT CWidgetBase
{
...
public:
   ...
   static QWidget * CustomParent(QWidget * widget);
...
private:
   ...
   static ClickFilter * _ClickFilter;
