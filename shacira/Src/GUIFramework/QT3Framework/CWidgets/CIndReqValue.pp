...
/**!
  ...
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CIndReqValue : public CReqValue
{
...
public slots:
   ...
   void NewVarName(const QCString VarName, int i1, int i2, int i3, int i4);
...
public:
   CIndReqValue(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CIndReqValue();
