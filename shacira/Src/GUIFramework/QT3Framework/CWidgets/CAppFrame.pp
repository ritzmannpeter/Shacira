...
/**!
  ...
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CAppFrame : public CWidget
{
...
public:
   CAppFrame(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CAppFrame();
...
public:
   ...
   virtual CActionDialog * GetActionDialog(const QString &  dialog_name, cPublicDialog * carrier);
   virtual void ActionDialogTerminated(const QString &  dialog_name, ULONG_T rc, cPublicDialog * dialog, CActionDialog * action_dialog);
