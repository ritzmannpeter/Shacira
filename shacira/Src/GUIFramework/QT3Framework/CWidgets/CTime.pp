...
/*!
  * @brief An input widget derived from QTimeEdit to manipulate the value of a CCS variable reference as time vale.
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CTime : public QTimeEdit, public CWidgetBase  
{
...
public:
   CTime(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CTime();
