...
/**!
  * @brief A container widget derived from QFrame.
  * <p>
  */
class SH_QT_WIDGET_PLUGIN_EXPORT CFrame : public QFrame, public CWidgetBase  
{
...
public:
   CFrame(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   ~CFrame();
};
