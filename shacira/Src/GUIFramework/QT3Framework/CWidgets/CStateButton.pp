 ...
 *
 * This class inherits @b QToolButton, CWidgetBase.
 */
class SH_QT_WIDGET_PLUGIN_EXPORT CStateButton : public QToolButton, public CWidgetBase  
{
...
public:
   ...
   PROPERTY_2i(QCString,ActionDialog)
   VAR_REF_2i(Var)
   VAR_REF_2i(ShowVar)
   VAR_REF_2i(Show2Var)
