...
#ifndef _cscrollview_h_
#define _cscrollview_h_
...
/**!
  * @brief scroll view widget
  * <p>
  */
class _CWIDGET_EXPORT_ CScrollView : public CSCROLLVIEW_BASE_CLASS, public CWidgetBase
{
   Q_OBJECT
...
protected:
   ...
   {
      CSCROLLVIEW_BASE_CLASS::paintEvent(e);
   };
   virtual void focusInEvent(QFocusEvent * e)
   {
      CSCROLLVIEW_BASE_CLASS::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      CSCROLLVIEW_BASE_CLASS::focusOutEvent(e);
   };
   void keyReleaseEvent(QKeyEvent * e)
   {
      CSCROLLVIEW_BASE_CLASS::keyReleaseEvent(e);
   };
...
public:
   CScrollView(CPage * page, QWidget * parent = 0, const char * name = 0, WIDGET_FLAGS_TYPE f = 0);
   ~CScrollView();
   CPage * Page()
   {
      return _Page;
