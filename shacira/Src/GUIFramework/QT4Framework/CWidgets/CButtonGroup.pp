...
/**!
  * @brief A container widget derived from BUTTONGROUP_BASE_CLASS to organize button widgets.
  * <p>
  */
class _CWIDGET_EXPORT_ CButtonGroup : public BUTTONGROUP_BASE_CLASS, public CWidgetBase  
{
...
protected:
   ...
   {
      BUTTONGROUP_BASE_CLASS::paintEvent(e);
   };
   virtual void focusInEvent(QFocusEvent * e)
   {
      BUTTONGROUP_BASE_CLASS::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      BUTTONGROUP_BASE_CLASS::focusOutEvent(e);
   };
   void keyReleaseEvent(QKeyEvent * e)
   {
      BUTTONGROUP_BASE_CLASS::keyReleaseEvent(e);
   };
public: 
