...
/**!
  * @brief A container widget derived from QGroupBox to organize subordinate widgets.
  * <p>
  */
class _CWIDGET_EXPORT_ CGroupBox : public QGroupBox, public CWidgetBase  
{
...
public:
   CGroupBox(QWidget * parent = 0, const char * name = 0, WIDGET_FLAGS_TYPE f = 0);
   ~CGroupBox();
#ifdef QT4
