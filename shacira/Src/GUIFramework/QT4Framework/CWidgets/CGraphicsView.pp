...
#ifndef _cgraphicsview_h_
#define _cgraphicsview_h_

#include <qgraphicsview.h>
#include "CWidgetbase.h"

class _CWIDGET_EXPORT_ CGraphicsView : public QGraphicsView, public CWidgetBase  
{
...
public:
   CGraphicsView(QWidget * parent = 0, const char * name = 0);
   ~CGraphicsView();
};
