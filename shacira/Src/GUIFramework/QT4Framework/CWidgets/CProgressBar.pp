...
class _CWIDGET_EXPORT_ CProgressBar : public QProgressBar, public CWidgetBase  
{
...
public:
   ...
   Q_PROPERTY( bool percentageVisible READ getPercentageVisible WRITE setPercentageVisible )
...
protected:
   ...
   {
      QProgressBar::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      QProgressBar::focusOutEvent(e);
   };
   void keyReleaseEvent(QKeyEvent * e)
   {
      QProgressBar::keyReleaseEvent(e);
   };
...
public:
   CProgressBar(QWidget * parent = 0, const char * name = 0, WIDGET_FLAGS_TYPE f = 0);
   ~CProgressBar();
private:
   ULONG_T _Value;
   ULONG_T _Maximum;
   BOOL_T _StyleSheetDefined;
// missing properties since Qt 4
public:
   void setPercentageVisible(bool state);
   bool getPercentageVisible() const;
};
