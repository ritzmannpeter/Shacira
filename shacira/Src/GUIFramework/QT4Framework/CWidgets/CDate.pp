...
/**!
  * @brief An input widget derived from QDateTimeEdit to manipulate the value of a CCS variable reference as date vale.
  * <p>
  */
class _CWIDGET_EXPORT_ CDate : public QDateEdit, public CWidgetBase  
{
...
public:
   CDate(QWidget * parent = 0, const char * name = 0, WIDGET_FLAGS_TYPE f = 0);
   ~CDate();
   virtual unsigned long GetDate();
