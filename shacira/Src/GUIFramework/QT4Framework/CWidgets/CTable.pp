...
#define CTABLE_BASE_CLASS			TableWidget
#define CTABLEITEM_BASE_CLASS		TableWidgetItem
#define CTABLE_ITEM_ITERATOR		TableWidgetItemIterator
#else
#include <qtable.h>
#define CTABLE_BASE_CLASS			QTable
#define CTABLEITEM_BASE_CLASS		QListViewItem
#define CTABLE_ITEM_ITERATOR		QListViewItemIterator
#endif

#if defined(QT_NO_TABLE)
#define QTable QWidget
#endif

#include "CWidgetbase.h"

class _CWIDGET_EXPORT_ CTable : public CTABLE_BASE_CLASS, public CWidgetBase  
{
...
public:
   // mising properties in QT4
   void setReadOnly(bool state) {CTABLE_BASE_CLASS::setReadOnly(state);};
   bool isReadOnly() const {return CTABLE_BASE_CLASS::readOnly();};
...
protected:
   ...
   {
      CTABLE_BASE_CLASS::paintEvent(e);
   };
   virtual void focusInEvent(QFocusEvent * e)
   {
      CTABLE_BASE_CLASS::focusInEvent(e);
   };
   virtual void focusOutEvent(QFocusEvent * e)
   {
      CTABLE_BASE_CLASS::focusOutEvent(e);
   };
