...
#ifndef _cunported_h_
#define _cunported_h_

#include "CWidgetBase.h"
#include <qwidget.h>

class _CWIDGET_EXPORT_ CUnported : public QWidget, public CWidgetBase  
{
   Q_OBJECT
...
public:
   ...
   // shows original class name of unported class
   PROPERTY_2i(QString,originalClass)
