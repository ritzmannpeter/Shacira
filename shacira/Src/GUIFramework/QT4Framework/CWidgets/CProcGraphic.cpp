...
#define XPIXEL_END() (rect().right())
#define YPIXEL_END() (rect().bottom())
#define PIXEL_WIDTH() (rect().width())
#define PIXEL_HEIGHT() (rect().height())
...
CProcGraphic::CProcGraphic(QWidget * parent, const char * name, WIDGET_FLAGS_TYPE f)
#ifdef QT4
   : QFrame(parent),
#else
...
#ifdef QT4
   painter.drawImage(0, 0, _DoubleBuffer.toImage());
#else
