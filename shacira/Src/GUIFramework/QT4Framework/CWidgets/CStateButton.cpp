...
void CStateButton::paintEvent(QPaintEvent * e)
{
   QToolButton::paintEvent(e);
}

void CStateButton::showEvent(QShowEvent * e)
{
   if (_ButtonStyleValue != QtSpecific) {
      ShowState();
   }
...
void CStateButton::hideEvent(QHideEvent * e)
{
   QToolButton::hideEvent(e);
}

void CStateButton::setButtonStyle(const ButtonStyles &value)
{ 
...
void CStateButton::SetIcon(const QPixmap & pixmap)
{
   QIcon icon;
