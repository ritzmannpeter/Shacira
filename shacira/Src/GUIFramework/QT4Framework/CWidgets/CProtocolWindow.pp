...
#ifndef CPROTCOLWINDOW_H
#define CPROTCOLWINDOW_H

#include <qtextedit.h>
#include "CWidgetBase.h"

class _CWIDGET_EXPORT_ CProtocolWindow : public QTextEdit, public CWidgetBase  
{
...
public:
   ...
   PROPERTY_2i(QByteArray,Key)
   PROPERTY_2i(QByteArray,ObjectName)
...
public:
   CProtocolWindow(QWidget * parent = 0, const char * name = 0, WIDGET_FLAGS_TYPE f = 0);
   ~CProtocolWindow();
