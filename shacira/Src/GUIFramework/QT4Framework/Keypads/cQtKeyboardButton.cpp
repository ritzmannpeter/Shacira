...
QT_PLUGIN_REGISTER(cQtKeyboardButton,"cQtKeyboardButton.h", "pushbutton","Keypads",0,0,false)
#endif
...
void cQtKeyboardButton::setPixmap(const QPixmap & pixmap)
{
   setIcon(pixmap);
}

void cQtKeyboardButton::setToggleButton(bool state)
{
   setCheckable(state);
}
