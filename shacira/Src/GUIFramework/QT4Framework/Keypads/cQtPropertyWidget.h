...
#ifdef QT4
   // depth first search as documented in Qt 4 porting hints
   QObject * child(QObject * object, const char * objName, const char * inheritsClass = 0, bool recursiveSearch = true) const;
#endif
};
