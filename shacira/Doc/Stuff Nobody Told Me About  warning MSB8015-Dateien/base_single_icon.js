...
//        });
    ...
    addAn: function(){
        ...
        if( !sp.sfIcon.an ) {
            ...
            sufio.style(sp.sfIcon.an ,{
                ...
                top: "-200px",
                left: "-200px",
                filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" + "scanImageUrl,sizingMethod='image')",
    ...
    getItemJSON: function( img ) {
        ...
        // if we didn't get a good result - try pp.
