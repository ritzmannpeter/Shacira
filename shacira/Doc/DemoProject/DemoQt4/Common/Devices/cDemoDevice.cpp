...
void * cDemoDevice::GetObject(CONST_STRING_T buf_spec, ULONG_T address, ULONG_T flags)
{
   return NULL;
}

void * cDemoDevice::GetObject(CONST_STRING_T buf_spec, CONST_STRING_T name, ULONG_T flags)
{
   return NULL;
}
