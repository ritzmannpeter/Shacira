...
#ifndef _RobotFrameImpl_h_
#define _RobotFrameImpl_h_
 ...
 * is contained in the file Robot.ui
 * Robot.h and Robot.cpp are generated
 * by Qt's uic and moc tools both files must be added
 * to the build environment.
 *
 */

class RobotFrameImpl : public RobotFrame
{
   Q_OBJECT
public:
   /*!
    * constructor
    */
   RobotFrameImpl(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   /*!
    * destructor
    */
   virtual ~RobotFrameImpl();
   /*!
