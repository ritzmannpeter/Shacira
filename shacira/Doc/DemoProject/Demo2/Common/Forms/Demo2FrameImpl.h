...
#ifndef _Demo2FrameImpl_h_
#define _Demo2FrameImpl_h_

#include "Demo2Frame.h"

/*!
 * implementation of the SHACIRA application frame
 * it inherits from a form of type CAppFrame that
 * is contained in the file Demo2.ui
 * Demo2.h and Demo2.cpp are generated
 * by Qt's uic and moc tools both files must be added
 * to the build environment.
 *
 */

class Demo2FrameImpl : public Demo2Frame
{
   Q_OBJECT
public:
   /*!
    * constructor
    */
   Demo2FrameImpl(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
   /*!
    * destructor
    */
   virtual ~Demo2FrameImpl();
   /*!
