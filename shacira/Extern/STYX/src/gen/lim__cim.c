...
{ CTX_T ctx;
  ...
  CTX_set(ctx,10,"tokens",   CTX_OPT,CTX_FLAG,  StrCopy("true"));
  CTX_set(ctx,11,"symbols",  CTX_OPT,CTX_FLAG,  StrCopy("false"));
  CTX_set(ctx,12,"BINSTYX",  CTX_ENV,CTX_PATH,  StrCopy("PATH"));
  CTX_ctx_set(ctx);
