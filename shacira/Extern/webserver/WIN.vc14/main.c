 ...
 *
 * $Id: main.c,v 1.5 2003/12/01 23:52:30 hwolff Exp $
 */
...
#define SH_INTEGRATION
#ifdef SH_INTEGRATION
#include "../sh/webintegration.h"
#endif
 ...
 */
   ...
   websUrlHandlerDefine(T("/cgi-bin"), NULL, 0, websCgiHandler, 0);
	websUrlHandlerDefine(T(""), NULL, 0, websDefaultHandler, 
		WEBS_HANDLER_LAST); 
#ifdef SH_INTEGRATION
   websUrlHandlerDefine(T("/shacira"), NULL, 0, ShaciraHandler, 0);
   websUrlHandlerDefine(T("/original"), NULL, 0, ShaciraHandler, 0);
#endif
