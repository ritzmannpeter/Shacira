...
#define BUG      bug(C_False,"")

#define assert0(cond,txt)     (( !(cond) ) ? (assert(C_False,(txt)),0):0)
#define assert1(cond,txt,a1)  (( !(cond) ) ? (assert(C_False,(txt),(a1)),0):0)
#define assert2(cond,txt,a,b) (( !(cond) ) ? (assert(C_False,(txt),(a),(b)),0):0)
#define bug0(cond,txt)        (( !(cond) ) ? (bug(C_False,(txt)),0):0)
#define bug1(cond,txt,a1)     (( !(cond) ) ? (bug(C_False,(txt),(a1)),0):0)
#define bug2(cond,txt,a,b)    (( !(cond) ) ? (bug(C_False,(txt),(a),(b)),0):0)
