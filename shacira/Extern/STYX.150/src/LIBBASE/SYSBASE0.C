...
/*DOC_INTERFACE*/
#define assert   (*(_AssCheck("Restriction error",__FILE__,__LINE__)))
#define bug      (*(_AssCheck("Internal error",   __FILE__,__LINE__)))
#define BUG      bug(False,"")

/*INTERFACE*/
#define assert0(cond,txt)     (( !(cond) ) ? (assert(False,(txt)),0):0)
#define assert1(cond,txt,a1)  (( !(cond) ) ? (assert(False,(txt),(a1)),0):0)
#define assert2(cond,txt,a,b) (( !(cond) ) ? (assert(False,(txt),(a),(b)),0):0)
#define bug0(cond,txt)        (( !(cond) ) ? (bug(False,(txt)),0):0)
#define bug1(cond,txt,a1)     (( !(cond) ) ? (bug(False,(txt),(a1)),0):0)
#define bug2(cond,txt,a,b)    (( !(cond) ) ? (bug(False,(txt),(a),(b)),0):0)
...
/*INTERFACE*/
#define I32_HIGHVAL(v)    ( (short)((v) >> 16) )
#define I32_LOWVAL(v)     ( (short)((v) & 0xFFFF) )
#define SET_I32_VAL(h,l)  ( (((h) << 16) & 0xFFFF0000) | ((l) & 0x0000FFFF) )
