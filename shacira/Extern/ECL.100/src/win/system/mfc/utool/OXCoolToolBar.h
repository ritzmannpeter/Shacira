...
implements those methods: COXCustomTBButtonWnd, which is declared as following:
	...
	class OX_CLASS_DECL COXCustomTBButtonWnd :	public PARENTWND, 
...
As you can see the implemented functionality would satidfy only simple window
...
derived classes should be implemented. This class is declared as:
	...
	class OX_CLASS_DECL COXCustomTBComboBox : public COXCustomTBButtonWnd<PARENTCOMBOBOX>
...
COXCustomTBSubclassedComboBox is declared as following:
	...
	class OX_CLASS_DECL COXCustomTBSubclassedComboBox : 
...
protected:
	...
	// in the toolbar
	int m_nCheckForDragDropEventTimerID;
...
//
template<class PARENTWND>
class OX_CLASS_DECL COXCustomTBButtonWnd : 
...
COXCustomTBButtonWnd<PARENTWND>::CBCreateCopy(CWnd* pParent) const
{
	...
	CBCopyContents(dynamic_cast<COXCustomTBButtonTemplate*>(pNewWnd));

	return dynamic_cast<COXCustomTBButtonTemplate*>(pNewWnd);
}
...
CBCreateNewInstance() const
{
	return dynamic_cast<COXCustomTBButtonTemplate*>(
		new COXCustomTBComboBox<PARENTCOMBOBOX>);
}
