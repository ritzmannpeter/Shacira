...
printf("%d\n", __LINE__);
printf("%d <= %p,%d\n", wanted_size, (void*)(_data->mem), *((int *)_data->mem));
...
printf("%d\n", __LINE__);
printf("shmget(%p,%p,%d,%08x)\n", (void*)_data->key, (const char*)_data->key->getKey(), size, (int)_data->key->getFlags());
...
printf("%d\n", __LINE__);
printf("shmget(%p,%d,%08x)\n", (const char*)_data->key->getKey(), size, (int)_data->key->getFlags());
