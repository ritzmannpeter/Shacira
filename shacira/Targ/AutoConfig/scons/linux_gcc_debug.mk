...
linux_gcc_debug/scons: $(A_TARGETS)
	$(link)

all: dependencies linux_gcc_debug $(A_TARGETS) linux_gcc_debug/scons

linux_gcc_debug: linux_gcc_debug.mk
	$(mkdir) $@

linux_gcc_debug/SysCons.o: ../../../Src/Apps/SysCons/SysCons.cpp
	$(cpp)
