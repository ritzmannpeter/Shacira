...
linux_gcc_debug/mdlc: $(A_TARGETS)
	$(link)

all: dependencies linux_gcc_debug $(A_TARGETS) linux_gcc_debug/mdlc

linux_gcc_debug: linux_gcc_debug.mk
	$(mkdir) $@

linux_gcc_debug/mdlc.o: ../../../Src/Tools/mdlc/mdlc.cpp
	$(cpp)
